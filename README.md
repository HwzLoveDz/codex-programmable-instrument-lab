...
当前首个经过实机流程验证的目标是 **SIGLENT SDS3104X HD**。仓库同时保留适配器约定，方便后续增加信号源、电源、电子负载、万用表和其他 SCPI/VISA 仪器，但不会假定不同型号共享同一套命令。
...
- [SDS3000X HD 产品页](https://www.siglent.com/int/products-overview/sds3000x-hd/)
